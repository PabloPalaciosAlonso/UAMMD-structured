...
simulation["system"]["info"]["parameters"]["name"] = "UniformMagneticField"
...
for i in range(N):
    simulation["state"]["data"].append([i, [0,0,0], [1.0 ,0 ,0, 0 ], anisotropy, [0,1,0,magneticMoment]])
...
#simulation["topology"]["forceField"]["External"]["data"] = []
#Output
